    ...
    <section className="lg:pt-[150px] md:pt-[100px] pt-20">
      <div className="container">
        <div className="text-center">
          ...
          <div className="max-w-[573px] block m-auto mb-[70px]">
            <AnimatedHeading text="High-Quality Laundry & Dry Cleaning." />
          </div>
        </div>
        <div
          ref={ref}
          className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 xxl:gap-[29px] lg:gap-4 gap-[29px]"
        >
              ...
              <div key={index}>
                {inView && (
                  <div className="zoomIn">
                    ...
                    <div className="xs:-mt-10 -mt-3 sm:mx-[30px] mx-4 sm:px-[26px] px-4 pt-[30px] pb-[66px] border border-primary/15 bg-white">
                      <div>
                        <ul>
        ...
        <div className="text-center mt-[60px]">
          <FadeUpAnimationProvider>
            <h3 className="text-[20px] font-medium leading-[30px] -tracking-[2%] text-primary">
              Free Collection & Delivery $20 Minimum <br /> Order No Service
              Fee.
            </h3>
          </FadeUpAnimationProvider>
          <FadeUpAnimationProvider>
