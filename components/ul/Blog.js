    ...
    <section className=" lg:py-[150px] md:py-[100px] py-20">
      <div className="container">
        <div className=" flex flex-wrap gap-10 items-end justify-between ">
          ...
          <div className=" ">
            <button
              className="group w-[188px] pl-[30px] text-center leading-[54px] border border-[#d9dbdf] transition-all duration-700 ease-in-out relative z-[1] overflow-hidden cursor-pointer  hover:text-white  before:content-[''] before:w-0 before:h-[200px] before:absolute before:top-[-80px] before:right-[-60px] 
