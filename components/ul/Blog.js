          ...
          <div className="">
            <div className="">
              <FadeUpAnimationProvider>
                <h5 className="text-primary/70 leading-[27px]  border border-[rgb(217,219,223)] px-[20px] py-0 inline-block mb-[15px]">
                  <span className="mr-2">•</span>Latest News & Blog
                </h5>
              </FadeUpAnimationProvider>
            </div>
            <div className="max-w-[649px]">
              <AnimatedHeading text="Clothing Care & Laundry Best Practices." />
            </div>
          </div>
          <FadeUpAnimationProvider>
            <div className="">
              <div
                className="group w-[188px] pl-[30px] text-[15px] font-medium text-center leading-[54px] border border-[#d9dbdf] transition-all duration-700 ease-in-out relative z-[1] overflow-hidden cursor-pointer  hover:text-white  before:content-[''] before:w-0 before:h-[200px] before:absolute before:top-[-80px] before:right-[-60px] 
...
"
        ...
        <div className="pt-[68px]">
          <div
            ref={ref}
            className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2   gap-[30px]"
          >
            {blogs.map((blog, index) => {
              return (
                <div key={index}>
                  {inView && (
                    <div className="relative zoomIn">
                      ...
                      <div
                        className="pt-[13px] flex flex-col justify-end items-start
"
                      >
                        <div
                          className="flex flex-wrap   sm:gap-[20px] gap-4
"
                        >
                          <p
...
"
                        ...
                        <div
                          className="border border-[#14213724] w-full mt-[13px] mb-8
"
                        ></div>
