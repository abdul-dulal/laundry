...
const Details = () => {
  return (
    <section>
      <div className="lg:pt-[150px] md:pt-[100px] pt-20">
        <div className="container">
                  ...
                  <div className="pb-[15px] border-b border-solid border-[#d9dbdf]">
                    ...
                    <div className="pt-[15px]">
                      <p className="text-[16px] text-[#142137b3]">
                        ...
                        client-focused bandwidth. Objectively impact cross-media
                        materials rather than covalent initiatives. Dynamically
                        pontificate holistic with.
                      </p>
                    </div>
                  </div>
                  <div className="pt-4">
          ...
          <div className="pt-[72px]">
            ...
            <p className="text-[16px] leading-[26px] text-primary/70">
              ...
              readily available in my training data. It's possible that Kristin
              Watson is not a widely recognized public figure or that any
              relevant information about them has <br /> emerged since my last
              update.{" "}
            </p>
            <p className="pt-[27px] text-[16px] leading-[26px] text-primary/70">
              ...
              online platforms for the latest information about them. If there's
              a specific context or field you're referring to, providing
              additional details may help me <br /> provide a more accurate and
              relevant response.
            </p>
          </div>
        </div>
