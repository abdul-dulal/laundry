...
const Quote = () => {
  return (
    <blockquote className="lg:mt-[60px] mt-3 flex flex-col justify-center items-center gap-[15px] sm:p-[40px] p-5 text-center relative bg-[#ebeff3]">
      <div className="">
        <svg
          width="34"
          height="30"
      ...
      <footer className="font-medium text-[20px] leading-[170%] tracking-[-0.02em] text-[#142137] mt-[19px]">
        Don Guidelines
      </footer>
    </blockquote>
  );
