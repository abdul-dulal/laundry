...
const Price = () => {
  return (
    <section className="second_price_packages_area pt-[100px] bg-[#181D4C]">
      <div className="container">
        <div className="heading_area style_1 text-center">
          <div className="">
        ...
        <div className="price_packages_wrapper grid grid-cols-12">
          {/* col-xxl-3 col-xl-3 col-12 */}
          <div className="xxl:col-span-3 col-span-6 ">
            <div className="price_packages_card_area flex  xxl:flex-col flex-row justify-start items-start gap-[30px]">
              <PriceContent
                img={shirt}
          ...
          <div className="xxl:col-span-6 col-span-12">
            <div className="price_image w-full flex flex-row justify-center items-center">
              <div className="price_packages_img_area rounded-full bg-[#ffffff0f] w-full max-w-[812px] h-[812px] relative">
                <Image
          ...
          <div className="xxl:col-span-3 col-span-6">
            <div className="price_packages_card_area style_1 flex flex-col justify-start items-start gap-[30px]">
              <PriceContent
                img={blanket}
