...
"
                    >
                      Scheduling a pickup is as easy as visiting our website or
                      using our mobile app. You can choose a convenient time
                      slot, and we'll be at your doorstep. We're happy
...
"
                    >
                      ...
                      fabric-appropriate detergents to strict adherence to care
                      instructions, we ensure every item is treated with
                      respect. Benefit from our doorstep collection and return,
                      designed for your comfort and convenience. Would you like
                      a more casual version, or something for use in marketing
                      material?
                    </p>
                  </div>
                  <div class=" mt-10">
...
"
                        >
                          Gentle on Fabrics, Strong on Clean
                        </p>
                      </li>
                      <li
                        className="flex flex-row justify-center items-start gap-[8px]
...
"
                        >
                          Elevate Your Style, Uplift Your Mood
                        </p>
                      </li>
                      <li
                        className="flex flex-row justify-center items-start gap-[8px]
...
"
                        >
                          Only the Finest for Your Fashion
                        </p>
                      </li>
                    </ul>
                  </div>
...
"
                  >
                    ...
                    undergoes regular training to handle garments with care. It
                    depends on your lifestyle a preferences. For most
                    ...
                    to guarantee the safety of your garments. Additionally, our
                    staff undergoes regular training to handle garments with
                    care. It depends on your lifestyle and preferences. For most
                    households, a weekly or bi-weekly schedule works well.
                    However, individuals with specific needs may choose more
                    frequent service. We use eco-friendly,
                  </p>
                </div>
              </div>
            </div>
